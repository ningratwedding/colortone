...
const pageTitle = 'Pengaturan Akun';
const pageDescription = 'Kelola informasi profil, langganan, dan preferensi Anda di LinkStore.';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: `${siteConfig.url}/account/settings`,
