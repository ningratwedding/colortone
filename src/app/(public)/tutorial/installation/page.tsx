...
import { FileArchive, FileCheck, FileDown, Wand2, Smartphone, Monitor, Video } from 'lucide-react';
          ...
          <Tabs defaultValue="desktop-photo" className="w-full">
            ...
            <TabsContent value="video-editing" className="border rounded-b-md p-6 mt-0 border-t-0">
                <h2 className="text-xl font-bold mb-4 font-headline">Instalasi LUTs di Editor Video (File .CUBE)</h2>
                 <div className="space-y-6">
                     <Step icon={FileDown} title="1. Unduh & Ekstrak File .CUBE">
                        <p>Unduh file .zip dari pembelian Anda dan ekstrak untuk menemukan file LUT dengan format <code className="bg-muted px-1 py-0.5 rounded text-xs">.cube</code>.</p>
                    </Step>
                    <Step icon={Wand2} title="2. Instalasi di Adobe Premiere Pro">
                         <ol className="list-decimal list-inside space-y-1">
                           <li>Buka Premiere Pro.</li>
                    ...
                    <Step icon={FileCheck} title="3. Instalasi di DaVinci Resolve">
                        <ol className="list-decimal list-inside space-y-1">
